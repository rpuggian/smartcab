...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.999):
    ...
    def get_maxQ(self, state):
        ...
        for action, Q in self.Q[state].items():
            if Q == maxQ:
                actions_maxQ.append(action)

        return maxQ, actions_maxQ 
    ...
    def choose_action(self, state):
        ...
        action = action = random.choice(self.valid_actions)
        ...
        if self.learning:
            maxQ, actions_maxQ = self.get_maxQ(state)
